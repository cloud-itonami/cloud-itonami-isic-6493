# Operator Quickstart — Factoring activities

Shortest path from clone to a verified local dry-run for **ISIC 6493** (`cloud-itonami-isic-6493`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-6493.git
cd cloud-itonami-isic-6493
```
...
- Blueprint governor key: `factoring-governor`
- Likely source path: `factoring.governor.cljc`
